...
def calculate_metrics(true_labels, predicted_labels):
    ...
    mean_squared_error = np.mean((true_labels - predicted_labels) ** 2)
    return accuracy, precision, recall, f1_score, mean_squared_error

accuracy, precision, recall, f1_score, mse = calculate_metrics(y_train, cluster_labels)
...
# Step 12: Calculate evaluation metrics on the test dataset
accuracy_test, precision_test, recall_test, f1_score_test, mse_test = calculate_metrics(y_test, predicted_test_labels)
...
print(f"F1-Score with optimal clusters: {f1_score_test:.2f}")
